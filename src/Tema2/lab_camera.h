    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::mat4 dir = glm::rotate(glm::mat4(1), angle, right);

            forward = dir * glm::vec4(forward, 1);
            forward = glm::normalize(forward);
            
            up = dir * glm::vec4(up, 1);
            up = glm::normalize(up);
        }
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::mat4 dir = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0));
            
            forward = dir * glm::vec4(forward, 1);
            forward = glm::normalize(forward);

            right = dir * glm::vec4(right, 1);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 dir = glm::rotate(glm::mat4(1), angle, forward);
